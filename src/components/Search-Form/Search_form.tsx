...
export const Search_form = ()=> {
  ...
  <Box sx={{width: 300  }}>
    ...
    <Slider  defaultValue={20} {...register("Select Men Age:")} valueLabelDisplay="auto" step={1} marks min={18} max={60} />
  </Box>
  </div>
  ...
  <div className='time1'>
  <Box sx={{ width: 300 }}>
    <Slider defaultValue={6} {...register("Morning Timing")} 
  ...
  <Box sx={{ width: 300 }}>
    ...
    <Slider defaultValue={4} {...register("Night Timing")} valueLabelDisplay="auto" step={1} marks min={4} max={10} />
  </Box>
  </div>
