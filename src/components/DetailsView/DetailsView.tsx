...
import { Help_Search } from '../Help-Search/Help_Search';
        ...
        <div className="details-view">
            ...
            {ServiceProvidersData.map(serviceproviders =>{
                 return <div className='views'>
                    <ServiceProvidersDetails key={serviceproviders['id']} props={serviceproviders} ></ServiceProvidersDetails>
                 </div>
            })}
            </div>
            
           <Help_Search open={open} selectedValue={''} onClose={handleClose}></Help_Search>
